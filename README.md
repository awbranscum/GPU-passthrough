...
Ensure a suitable Python version is installed and available on your PATH.

Create and activate a virtual environment to isolate project dependencies.

Use the provided Windows batch installer to upgrade pip tools and install Python packages: FastAPI, Uvicorn, Pydantic, Transformers, and an appropriate PyTorch build (GPU-enabled if you have CUDA).

Confirm that packages import without errors and that torch recognizes your GPU(s) if present.
